...
{
    case 'index':
        $view->photos=Photo::getPhotos(); // tree todas las fotos
        $view->contentoTemplate="templates/clientesGrid.php"; // seteo el template que se va a mostrar
        break;
    case 'refreshGrid':
    ...
    case 'newPhot':
        ...
        $view->contentoTemplate="templates/clientForm.php"; // seteo el template que se va a mostrar
        break;
    case 'editPhot':
...
{include_once ($view->contentoTemplate);}
else
