...
class Conexion  // se declara una clase para hacer la conexion con la base de datos
{
	...
	function Conexion()
	{
		...
		/*$conection['server']="mysql2.000webhost.com";  //host
		$conection['user']="a6769825_silvia";         //  usuario
		$conection['pass']="160989london";             //password
		$conection['base']="a6769825_ddbb";           //base de datos*/
...
class Photo
{
    ...
    public static function getPhotos() 
		{
			...
			$obj_photo->executeQuery("select * from photos"); // ejecuta la consulta para traer al photo
	...
	{
			$obj_photo=new sQuery();
			$query="update photos set title='$this->title', location='$this->location',description='$this->description',publicar='$this->publicar' where id = $this->id";
	...
	{
			$obj_photo=new sQuery();
			$query="insert into photos( title, location, description,publicar)values('$this->title', '$this->location','$this->description','$this->publicar')";
