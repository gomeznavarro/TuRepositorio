...
FOTO.Slider = {
	...
	loadingURL : '/aeca/photos/cafeteria.jpg',
	baseURL : '/aeca/photos/',
	thumbURL : 'cafeteria.jpg',
	mainURL : 'cafeteria55_mini.jpg',
...
getDesFromId: function(key,id){
		if(this.bucket[key] != null && this.bucket[key][id] != null){
			return this.bucket[key][id]['des'];
		}
	},
	...
	reload: function(key){
		...
		var sliderDes = $(document.createElement('div'));
		sliderCaption.addClass('photoslider_caption');
		sliderDes.addClass('photoslider_des');

		sliderDiv.append(sliderCaption);
		sliderDiv.append(sliderDes);
	...
	displayMainImage: function(img){
		...
		var caption = $('#'+key+' .photoslider_caption');
			var des = $('#'+key+' .photoslider_des');
		var captionTxt = FOTO.Slider.getCaptionFromId(key,id);
				var desTxt = FOTO.Slider.getDesFromId(key,id);
		...
		if(captionTxt == null){
			captionTxt = '&nbsp;'; //make it play nice in browsers like ie
				...
				if(desTxt == null){
			desTxt = '&nbsp;'; //make it play nice in browsers like ie
		}
