...
displayPageHeaders( "Tarjeta Clientes AECA", $membersArea = false, $noticias = false, $gallery=false);
...
displayCentral($membersArea = false, $menu=false, "Tarjeta Clientes", $banner=false, $foto=true, $gallery=false, $socios_menu=false, $clientes_menu=true);
?>
