...
$(document).ready(function(){
	      $("#enlacemostrarcat").css("display","none");

	 //código a ejecutar cuando el DOM está listo para recibir instrucciones.
	$("#enlaceocultarcat").click(function(evento){ //para aplicar evento a nuestro enlaces
//$("a").click(function(evento){ //para aplicar evento a todos los enlaces
   //aquí el código que se debe ejecutar al hacer clic
   
   $("#cat2").css("display","none");
      $("#enlaceocultarcat").css("display","none");
 $("#enlacemostrarcat").css("display","block");
   evento.preventDefault();
	});
	$("#enlacemostrarcat").click(function(evento){ //para aplicar evento a nuestro enlaces
//$("a").click(function(evento){ //para aplicar evento a todos los enlaces
   //aquí el código que se debe ejecutar al hacer clic
   
   $("#cat2").css("display","block");
         $("#enlaceocultarcat").css("display","block");
$("#enlacemostrarcat").css("display","none");
	});
