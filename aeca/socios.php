...
displayCentral($membersArea = false, $menu=false, "Socios", $banner=false, $foto=true, $gallery=false, $socios_menu=true, $clientes_menu=false);
?>
    ...
    <?php if(isset($_SESSION['member'])&& $_SESSION['member']!='') echo '<div class="logged">Est&aacute;s identificado como <strong>'. $_SESSION['member']->getValue('username').'</strong> | <a class="infos" href="members/logout.php">Logout</a></div>';
        ...
        <div id="global_lateralycontenido"> <!-- igualar columnas -->
            ...
            <div id="lateral">
                <div id="cat">
                    <?php require ("menu_cat_socios.inc.php"); ?>
                </div>
            </div><!-- //LATERAL -->
