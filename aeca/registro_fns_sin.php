...
<?php } }?>
    <form action="register_sin.php" method="post" style="margin-left: 100px; margin-bottom: 50px;" id="registro" name="registro" >
    ...
    <div style="width: 500px; float:left; margin-bottom:20px">
        ...
        <fieldset>
            ...
            </select><span style="position:absolute; top:500px; left:150px; color:#900" id='Buscando'> </span>
            ...
            <option value='0'>Seleccione población...</option>
             <?php
                $query= mysql_query ("SELECT * FROM municipios order by municipio asc",$link);
                $array=mysql_fetch_assoc($query);
                $num=mysql_num_rows($query);
                $suma=0;
                do{ ++$suma;
                echo "<option value='".$array['id']."'>".$array['municipio']."</option>";
                }while($array=mysql_fetch_assoc($query));?>
            </select>            
        ...
        <fieldset>
            ...
            <legend class="visible">Aceptaci&oacute;n t&eacute;rminos</legend>
...
$username= new_user(); 	//Genero un usuario aleatoriamente en el registro de miembros, que quedará asociado a los datos introducidos por los usuarios
  ...
  if ( $errorMessages ) {
	...
	?>
    <div id="contenido" style="margin-top:20px; margin-bottom:20px; margin-left:100px">
